    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organ_problem_speci', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='prediction', to='organ_problem_speci.organsproblemspecification')),
            ],
            options={
                'db_table': 'prediction',
            },
