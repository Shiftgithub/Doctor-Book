...
from admin.doctor.serializers import OffDaySerializer,AppointmentScheduleSerializer
    ...
    if get_working_schedule_response.status_code == 200:
        ...
        for item in schedule_times_data:
            ...
            for _ in range(num_appointments):
                ...
                formatted_start_time = (datetime(1900, 1, 1, current_time // 60, current_time % 60)).strftime("%I:%M %p")
                formatted_end_time = (datetime(1900, 1, 1, end_time_patient // 60, end_time_patient % 60)).strftime("%I:%M %p")
