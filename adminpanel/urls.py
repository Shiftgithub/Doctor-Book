...
urlpatterns = [
    ...
    path('adminpanel/', include([
        ...
        path('article/', include([
            ...
            path('view/<int:article_id>/', protected_view(view_article), name='view_article_data'),
            path('update/<int:article_id>/', protected_view(edit_article_form), name="edit_article_form"),
