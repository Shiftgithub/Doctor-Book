...
def organ_problem_specification_form(request):
    ...
    return render(request, 'admin/organ_problem_specification/form.html', {'bodypart_data': bodypart_data})
...
def organ_problem_specification_data_view(request):
    ...
    return render(request, 'admin/organ_problem_specification/list_all.html', {'all_data': all_data})
...
def edit_organ_problem_specification_form(request, organ_problem_specification_id):
    ...
    return render(request, 'admin/organ_problem_specification/edit.html',
...
def view_organ_problem_specification(request, organ_problem_specification_id):
    ...
    return render(request, 'admin/organ_problem_specification/view.html', {'organ_problem_specification_data': organ_problem_specification_data})
