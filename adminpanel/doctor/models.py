...
class PresentAddress(models.Model):
    ...
    doctor_profile = models.ForeignKey(
        Doctor_Profile,
        on_delete=models.CASCADE,
        related_name="present_addresses",
        null=True,
    )
...
class Images(models.Model):
    ...
    doctor_profile = models.ForeignKey(
        Doctor_Profile, on_delete=models.CASCADE, related_name="images", null=True
    )
...
class Education(models.Model):
    doctor_profile = models.ForeignKey(
        Doctor_Profile, on_delete=models.CASCADE, related_name="education"
    )
    certificate_degree = models.CharField(max_length=255)
    institution = models.CharField(max_length=255)
    board = models.ForeignKey(
        Board, on_delete=models.CASCADE, related_name="educationID"
    )
