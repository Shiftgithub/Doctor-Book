...
urlpatterns = [
    ...
    path(
        ...
        include(
            [
                path('form/', protected_view(department_specification_form), name='department_specification_form'),
                path('store/', protected_view(store_department_specification), name='store_department_specification'),
                path('list/', protected_view(department_specification_data_view), name='department_specification_list'),
