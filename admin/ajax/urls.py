    ...
    path(
        ...
        include(
            [
                ...
                path('appointment-medicine/<int:patient_id>/<int:doctor_id>/',
                     get_appointment_date_time_by_patient_name_for_medicine,
                     name='get_patient_appointments_by_name'),
                path('appointment-labtest/<int:patient_id>/<int:doctor_id>/',
                     get_appointment_date_time_by_patient_name_for_labtest,
                     name='get_patient_appointments_by_name'),
