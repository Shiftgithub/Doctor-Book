...
def find_doctors(request):
    ...
    return render(request, 'patient/templates/find_doctors.html', {'doctor_data': doctor_data})
...
def patient_predict_form(request):
    ...
    return render(request, 'patient/templates/prediction.html', {'bodypart_data': bodypart_data})
...
def predict_result(request):
    ...
    if operation_response.data.get('status') == 200:
        ...
        return render(request, 'patient/templates/predict_result.html',
